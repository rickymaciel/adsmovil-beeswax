    ...
    modules: {
        ...
        advertiser: {
            ...
            actions: {
                ...
                async all({ commit }) {
                    try {
                        const response = await AdvertiserService.all(undefined, {
                            order: "asc",
                            sort: "name"
                        });
            ...
            actions: {
                ...
                async create({ commit }, customList: CustomListDataCreate) {
                    try {
                        ...
                        notificationService.notifySuccess(this, {
                            to: { name: "CustomListEdit", params: { id: response.id } }
                        } as Notification);
                        return await Promise.resolve(response);
                    } catch (error) {
                        catchError(this, error);
            ...
            actions: {
                ...
                async show({ commit }, id: number) {
                    try {
                        ...
                        commit("SET_ITEM", response);
                        notificationService.notifySuccess(this, { to: "" } as Notification);
                        return await Promise.resolve(response);
                    } catch (error) {
                        commit("SET_ITEM");
                        catchError(this, error, { to: "" });
                ...
                async list(
                    { commit },
                    payload: { filters: ListItemFilters; options: ListItemOptions }
                ) {
                    try {
        ...
        modifier: {
            ...
            actions: {
                ...
                async list(
                    { commit },
                    payload: { filters: ModifierFilters; options: ModifierOptions }
                ) {
                    try {
        ...
        line_item: {
            ...
            actions: {
                ...
                async update(
                    { commit },
                    params: { lineItem: LineItemDataCreate; id: number }
                ) {
                    try {
                ...
                async list(
                    { commit },
                    payload: { filters: LineItemFilters; options: LineItemOptions }
                ) {
                    try {
                ...
                async all(
                    { commit },
                    params: { filters: LineItemFilters; options: LineItemOptions }
                ) {
                    try {
        ...
        creative: {
            ...
            actions: {
                ...
                async getCreativeTypeByTemplateId(
                    { },
                    params: { creativeTypes: Array<any>; creative_template_id: Number }
                ) {
                    try {
                        if (
