...
import { MraidTag, MraidTagDataCreate, MraidTagDataUpdate } from '@/interfaces/creativeBannerMraidTag'
import {
...
export async function create (creative: MraidTagDataCreate, token: string) {
  try {
...
export async function update (creative: MraidTagDataUpdate, token: string) {
  try {
...
function parseData (data): MraidTag {
