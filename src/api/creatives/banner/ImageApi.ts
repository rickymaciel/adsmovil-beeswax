...
import { Image, ImageDataCreate, ImageDataUpdate } from '@/interfaces/creativeBannerImage'
import {
  AddContent,
  AddonSetting,
  Advertiser,
  Attribute,
  ExchangeOption, ProgressEvent,
  Template,
  Type,
  VastEvent
...
export async function create (creative: ImageDataCreate, token: string) {
  try {
...
export async function update (creative: ImageDataUpdate, token: string) {
  try {
