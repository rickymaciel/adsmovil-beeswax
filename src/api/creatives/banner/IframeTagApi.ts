...
import { IframeTag, IframeTagDataCreate, IframeTagDataUpdate } from '@/interfaces/creativeBannerIframeTag'
import {
...
export async function create (creative: IframeTagDataCreate, token: string) {
  try {
...
export async function update (creative: IframeTagDataUpdate, token: string) {
  try {
...
function parseData (data): IframeTag{
