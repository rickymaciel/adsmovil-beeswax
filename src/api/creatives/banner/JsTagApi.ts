...
import { JsTag, JsTagDataCreate, JsTagDataUpdate } from '@/interfaces/creativeBannerJsTag'
import {
...
export async function create (creative: JsTagDataCreate, token: string) {
  try {
...
export async function update (creative: JsTagDataUpdate, token: string) {
  try {
