...
import { Html5, Html5DataCreate, Html5DataUpdate } from '@/interfaces/creativeBannerHtml5'
import {
...
export async function create (creative: Html5DataCreate, token: string) {
  try {
...
export async function update (creative: Html5DataUpdate, token: string) {
  try {
