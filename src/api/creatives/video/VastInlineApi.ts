...
import { VastInline, VastInlineDataCreate, VastInlineDataUpdate } from '@/interfaces/creativeVideoVastInline'
import {
...
export async function update (creative: VastInlineDataUpdate, token: string) {
  try {
...
function parseData (data): VastInline {
