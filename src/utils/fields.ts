...
const creative_39 = {
    ...
    updated_by: 2,
    deleted_by: null,
    created_at: "2021-07-09T21:10:15.000000Z",
    updated_at: "2021-07-09T21:10:16.000000Z",
    template: {
        id: 4,
        external_id: 4,
        creative_type_id: 21,
        name: "JS Tag",
        template_content: "<div id='beeswax-ad-wrapper' style='position: relative;'><img src=\"{{IMPRESSION_URL}}\" style=\"position: absolute;\" width='0' height='0'>{{CUSTOM:TAG:STRING}}{{#ADDITIONAL_PIXELS:0:10<img src='{{CUSTOM:PIXEL_URL:URL}}' width='0' height='0'>/}}{{#ADDITIONAL_SCRIPTS:0:10<script type='text/javascript' src='{{CUSTOM:SCRIPT_URL:URL}}'></script>/}}{{BEESWAX_COOKIE_SYNC_IFRAME}}</div>",
    },
    type: {
        id: 21,
        type: "line_item_type",
    ...
    creative_advertiser: {
        ...
        creative_id: 39,
        advertiser_id: 14,
        domain: "advertiser2.jstag.com",
        category_id: 2,
        app_bundle: "com.adsmovil.JsTag.Advertiser2",
        created_by: 2,
        updated_by: 2,
        deleted_by: null,
        created_at: "2021-07-09T21:10:15.000000Z",
        updated_at: "2021-07-09T21:10:15.000000Z",
    },
    creative_ad_content: {
        id: 43,
        creative_id: 39,
