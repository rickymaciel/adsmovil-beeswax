...
function getFilters(filters: CreativeFilters): string {
  ...
  const external_id =
    isUndefined(filters.external_id) || isNull(filters.external_id)
      ...
      : filters.external_id;
  const asset_type_id =
    isUndefined(filters.asset_type_id) || isNull(filters.asset_type_id)
      ? ""
  ...
  const model_type_id =
    isUndefined(filters.model_type_id) || isNull(filters.model_type_id)
      ? ""
      : filters.model_type_id;
  const active =
    isUndefined(filters.active) || isNull(filters.active) ? "" : filters.active;
