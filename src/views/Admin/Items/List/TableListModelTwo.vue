		...
		<v-card>
			<table>
				<thead>
					...
					<th style="width: 15%;" class="pt-2 pb-2">Tatitude</th>
					<th style="width: 15%;" class="pt-2 pb-2">Longitude</th>
					<th style="width: 10%;" class="pt-2 pb-2">Radius</th>
					<th style="width: 10%;" class="pt-2 pb-2">Value</th>
