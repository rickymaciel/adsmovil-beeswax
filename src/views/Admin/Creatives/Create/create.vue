...
export default Vue.extend({
	...
	methods: {
		updateCreativeType(data: { creative_type_id: number }) {
			...
			this.init_creative.creative_ad_content.thumbnail_id = null;
		},
		...
		async fetchAssets(key: string) {
			if (
				!this.init_creative.creative_advertiser.advertiser_id ||
				!this.init_creative.creative_template_id
			)
				return;
			...
			const params = {
				...
				creative_template_id: this.init_creative.creative_template_id,
